...
- Rad! Please [lint, format](https://github.com/xero/text0wnz/wiki/buildingAndDeveloping.md#code-quality-scripts), and [test](https://github.com/xero/text0wnz/wiki/testing.md) your code before submitting a [pull request](https://github.com/xero/text0wnz/pulls).
